...
const SLIDES: Slide[] = [
  {
    ...
    title_uz: 'Yalpiz — Toshkentdagi oilaviy restoran', title_ru: 'Yalpiz — семейный ресторан в Ташкенте',
    sub_uz: "Shota Rustaveli 115 dagi restoranimizda o‘zbek va turk taomlari, yetkazib berish va olib ketish xizmati.",
    sub_ru: 'Ресторан на Шота Руставели, 115: узбекская и турецкая кухня, доставка и самовывоз.',
    cta: 'order',
  },
  {
    ...
    title_uz: 'Issiq taomlarni qulay yetkazamiz', title_ru: 'Удобная доставка горячих блюд',
    sub_uz: 'Toshkent bo‘ylab yetkazib berish yoki restorandan olib ketish uchun buyurtma bering.',
    sub_ru: 'Оформите доставку по Ташкенту или закажите блюда навынос из ресторана.',
    cta: 'order',
  },
  {
    ...
    title_uz: 'Bir necha bosishda buyurtma bering', title_ru: 'Закажите в пару нажатий',
