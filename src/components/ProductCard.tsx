...
export default function ProductCard({
  ...
  return (
    <motion.div
      ...
      className="bg-white rounded-3xl overflow-hidden border border-brand-primary/5 hover:border-brand-primary/10 hover:shadow-xl hover:-translate-y-1 transition-all duration-300 flex flex-col h-full group"
    >
      ...
      <div className="p-5 sm:p-6 flex flex-col flex-grow">
        ...
        {/* Title */}
        <h3 className="font-serif italic text-lg sm:text-xl font-bold text-brand-dark leading-snug group-hover:text-brand-primary transition-colors">
          {name}
        </h3>

        {/* Description */}
        <p className="font-sans text-brand-muted text-xs sm:text-sm mt-2 leading-relaxed flex-grow line-clamp-3">
          {desc}
        </p>

        {/* Price and Action row */}
        <div className="mt-6 pt-4 border-t border-brand-primary/5 flex items-center justify-between gap-4">
          ...
          <div className="flex flex-col">
            ...
            <span className="font-sans text-base sm:text-lg font-extrabold text-brand-dark leading-none mt-1">
            ...
            <div className="flex-shrink-0">
              {quantityInCart > 0 ? (
                ...
                <button
                  ...
                  onClick={onAddToCart}
                  className="px-4 py-2.5 bg-brand-primary hover:bg-brand-dark text-white text-xs sm:text-sm font-bold rounded-xl transition-all duration-200 shadow-sm flex items-center gap-2 cursor-pointer active:scale-95"
                >
